...
# Data Binning
data["PT08.S1(CO)"] = pd.cut(data["PT08.S1(CO)"], bins = 50, labels = False)
data["PT08.S2(NMHC)"] = pd.cut(data["PT08.S2(NMHC)"], bins = 50, labels = False)
data["PT08.S3(NOx)"] = pd.cut(data["PT08.S3(NOx)"], bins = 50, labels = False)
data["PT08.S4(NO2)"] = pd.cut(data["PT08.S4(NO2)"], bins = 50, labels = False)
data["PT08.S5(O3)"] = pd.cut(data["PT08.S5(O3)"], bins = 50, labels = False)
